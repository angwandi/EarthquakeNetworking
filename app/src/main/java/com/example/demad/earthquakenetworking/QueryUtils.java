...
public class QueryUtils {
     ...
     * directly from the class name com.example.demad.earthquakenetworking.QueryUtils (and an object instance of com.example.demad.earthquakenetworking.QueryUtils is not needed).
     */
    private QueryUtils() {
    }
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //Extract the JSONObject from the SAMPLE_JSON_RESPONSE
            // string
